...
Through an iterative and incremental approach, by comparing user feedback and test results it was concluded that the final system is cable of fulfilling the overall requirements of the client to a satisfactory level.
...
\begin{itemize}
	...
	\item {\bf{Automate deployment process through DevOps techniques}} \\
