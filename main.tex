...
\index{Web-based}\index{TypeScript}\index{Environment}\index{Non-functional requirements}
...
\index{Requirement}\index{Functional requirements}
...
\index{Requirement}\index{Non-functional requirements}
...
\index{Architectural design}\index{Design strategy}\index{Interface}
...
\index{Requirement}\index{Web-based}\index{Design strategy}
...
\index{Interface}\index{MVC Architecture}
...
\index{Complexity}\index{User interface design}
...
\index{Requirement}\index{Transform}\index{Framework}
...
\index{Feasibility}\index{Environment}\index{Maintainability}\index{Performance}
...
\index{TypeScript}\index{Framework}
...
\index{Web server}\index{Framework}
...
\index{TypeORM}\index{TypeScript}
...
\index{Web-based}\index{Open-source}\index{Standard}
...
\index{Performance}\index{Functional requirements}\index{System testing}
...
\index{Requirement}\index{Standard}\index{Test plan}
...
\index{Technology}\index{TypeScript}
...
\index{Web-based}\index{Environment}
...
\setlist[description]{itemsep=2.0ex, leftmargin=0cm,rightmargin=0cm} % keep some space...looks nice
