...
Testing of the final product was performed by devising a test plan to test both technical aspects as well as user interactions. Under these two categories various test cases and tasks were performed to test components such as authentication, permission handling and interaction flow of user interfaces. 
